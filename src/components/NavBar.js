    ...
    <header className='px-4 lg:px-6 h-20 flex items-center justify-between border-b'>
      <div className='container mx-auto flex flex-row justify-between items-center'>
        ...
        <nav className='hidden md:flex space-x-8'>
          ...
          <a className='text-sm font-medium hover:text-blue-600 decoration-transparent' href='/servicios'>Serveis</a>
          <a className='text-sm font-medium hover:text-blue-600 decoration-transparent' href='/planes'>Plans</a>
          <a className='text-sm font-medium hover:text-blue-600 decoration-transparent' href='/about'>Sobre Nosatres</a>
        </nav>
