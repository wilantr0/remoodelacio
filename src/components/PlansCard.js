  ...
  return (
    <div className='w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8'>
      ...
      {month?
        ...
        <span className='text-5xl font-extrabold tracking-tight'>{priceM}</span>
      ...
      <div className='flex items-baseline text-gray-900 '>
        <span className='text-3xl font-semibold'>€</span>
        <span className='text-5xl font-extrabold tracking-tight'>{priceA}</span>
        <span className='ms-1 text-xl font-normal text-gray-500 '>
          /año
        </span>
      </div>
        ...
        {services.map( e=> {
          return(
            <li key={e} className='flex items-center'>
              <svg
                className='flex-shrink-0 w-4 h-4 text-blue-700 -500'
                aria-hidden='true'
              ...
              <span className='text-base font-normal leading-tight text-gray-700 ms-3'>
                {e}
              </span>
            </li>
          )
